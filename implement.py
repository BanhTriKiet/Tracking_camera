...
def main(_argv):
    ...
    while True:
        ...
        if converted_boxes and scores[0][0] and features.all():
            ...
            detections=[]
        # detections = [Detection(bbox, score, class_name, feature) for bbox, score, class_name, feature in islice(zip(converted_boxes, scores[0], names, features), 3)]
        ...
        # classes = names
        # if detections:
        #     boxs = np.array([detections[0].tlwh])
